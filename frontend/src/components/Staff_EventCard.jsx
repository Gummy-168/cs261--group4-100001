...
export default function StaffEventCard({
  ...
  const onNavigate = () => {
    ...
    // ถ้าไม่ได้ส่ง onOpen มาก็ไปหน้า staff event detail ในแท็บเดิม
      ...
      <div className="flex flex-col md:flex-row w-full">
        ...
        <div className="w-full md:w-60 border-t md:border-t-0 md:border-l border-black/5 bg-[#fafafa] px-6 py-5 flex flex-col justify-between">
          ...
          <div className="mt-6 flex flex-col gap-2">
            ...
            {/* ลบกิจกรรม (ยังเป็น TODO เหมือนเดิม) */}
            <button
              type="button"
              onClick={(ev) => {
                ev.stopPropagation();
                // TODO: ใส่ onDelete จาก parent ถ้าต้องการ
                console.log("delete event", e.id);
              }}
